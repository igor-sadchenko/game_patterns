...
# 1. Необходимо реализовать так, что бы можно было изменить настройки. (Например поставить выстрел на ПКМ.)
# 2* Так же нужно добавить возможность передавать в метод параметр(ы). (Например можно передавать юнит, который будет выполнять, команду)
